...
void main()
{
  ...
  float fb0_tex_mod=fb0_texmod_logic.x*ch1_hsbstrip.z+fb0_texmod_logic.y*ch1_hsbstrip.z;
  ...
  if(fb0_pixel_switch==1){
    ...
    float fb0_pixel_tex_mod=fb0_pixel_texmod_logic.x*ch1_hsbstrip.z+fb0_pixel_texmod_logic.y*ch1_hsbstrip.z;
  ...
  float fb1_tex_mod=fb1_texmod_logic.x*ch1_hsbstrip.z+fb1_texmod_logic.y*ch1_hsbstrip.z;
  ...
  if(fb1_pixel_switch==1){
    ...
    float fb1_pixel_tex_mod=fb1_pixel_texmod_logic.x*ch1_hsbstrip.z+fb1_pixel_texmod_logic.y*ch1_hsbstrip.z;
  ...
  float fb2_tex_mod=fb2_texmod_logic.x*ch1_hsbstrip.z+fb2_texmod_logic.y*ch1_hsbstrip.z;
  ...
  if(fb2_pixel_switch==1){
    ...
    float fb2_pixel_tex_mod=fb2_pixel_texmod_logic.x*ch1_hsbstrip.z+fb2_pixel_texmod_logic.y*ch1_hsbstrip.z;
  ...
  float fb3_tex_mod=fb3_texmod_logic.x*ch1_hsbstrip.z+fb3_texmod_logic.y*ch1_hsbstrip.z;
  ...
  if(fb3_pixel_switch==1){
    ...
    float fb3_pixel_tex_mod=fb3_pixel_texmod_logic.x*ch1_hsbstrip.z+fb3_pixel_texmod_logic.y*ch1_hsbstrip.z;
  ...
  vec4 mixout_color=mix_rgb(channel1_color,channel1_color,mix1,mix1blend1,mix1keybright,mix1keythresh,ch1_hsbstrip.z);
