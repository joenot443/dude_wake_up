...
{
    ImVec2 a = ImVec2(3 * p3.x, 3 * p3.y) - ImVec2(9 * p2.x, 9 * p2.y) + ImVec2(9 * p1.x, 9 * p1.y) - ImVec2(3 * p0.x, 3 * p0.y);
    ImVec2 b = ImVec2(6 * p0.x, 6 * p0.y) - ImVec2(12 * p1.x, 12 * p1.y) + ImVec2(6 * p2.x, 6 * p2.y);
    ImVec2 c = ImVec2(3 * p1.x, 3 * p1.y) - ImVec2(3 * p0.x, 3 * p0.y);
    ImVec2 delta_squared = ImMul(b, b) - ImVec2(4 * ImMul(a, c).x, 4 * ImMul(a, c).y);
...
inline ImCubicBezierIntersectResult ImCubicBezierLineIntersect(const ImVec2& p0, const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& a0, const ImVec2& a1)
{
  ...
  ImVec2 c3 = ImVec2(-p0.x + 3 * p1.x - 3 * p2.x + p3.x, -p0.y + 3 * p1.y - 3 * p2.y + p3.y);
  ImVec2 c2 = ImVec2(3 * p0.x - 6 * p1.x + 3 * p2.x, 3 * p0.y - 6 * p1.y + 3 * p2.y);
  ImVec2 c1 = ImVec2(-3 * p0.x + 3 * p1.x, -3 * p0.y + 3 * p1.y);
  ImVec2 c0 = p0;
