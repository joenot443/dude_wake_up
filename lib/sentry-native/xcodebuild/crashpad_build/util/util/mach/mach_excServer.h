...
extern
#endif
kern_return_t __MIG_check__Request__mach_exception_raise_t(__Request__mach_exception_raise_t *In0P);
#ifdef mig_external
mig_external
#else
extern
#endif
kern_return_t __MIG_check__Request__mach_exception_raise_state_t(__Request__mach_exception_raise_state_t *In0P, __Request__mach_exception_raise_state_t **In1PP);
#ifdef mig_external
mig_external
#else
extern
#endif
kern_return_t __MIG_check__Request__mach_exception_raise_state_identity_t(__Request__mach_exception_raise_state_identity_t *In0P, __Request__mach_exception_raise_state_identity_t **In1PP);
